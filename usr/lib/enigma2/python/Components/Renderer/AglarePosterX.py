...
class AglarePosterX(Renderer):
        ...
        for attrib, value in self.skinAttributes:
            if attrib == "nexts":
                ...
                try:
                    ...
                    logger.error(
                        "Failed to create poster path {}: {}".format(
    ...
    def showPoster(self, poster_path=None):
        ...
        try:
            ...
            logger.warning(
                "Poster load failed | file='{}' | error='{}'".format(
                    poster_path, str(e)))
    ...
    def refreshPoster(self):
        ...
        if self.poster_refresh_count < self.poster_refresh_max:
            ...
            logger.info(
                "Poster refresh stopped | file='{}'".format(
                    self.backrNm))
            self.poster_refresh_count = 0
        ...
        try:
            ...
            try:
                ...
                for provider_name, provider_func in sorted_providers:
                    try:
                        # Only providers in API_CONFIG require keys; keyless
                        # providers must run normally
